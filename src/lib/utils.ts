...
interface TotalSpace {
  document: { size: string; latestDate: string };
  image: { size: string; latestDate: string };
  video: { size: string; latestDate: string };
  audio: { size: string; latestDate: string };
  other: { size: string; latestDate: string };
}
